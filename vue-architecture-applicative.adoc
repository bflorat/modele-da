...
Le choix de la représentation est libre mais un diagramme C4 de System Landscape semble le plus adapté. Nous fournissons des patterns et des détails à ce sujet dans https://florat.net/architecture-as-code-with-c4-and-plantuml/[cet article].
