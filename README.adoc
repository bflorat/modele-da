...
* Ce modèle est perfectible, c'est pourquoi tous les retours, critiques (constructives), contributions et suggestions sont appréciées (faire une https://github.com/bflorat/modele-da/pulls[pull request]
