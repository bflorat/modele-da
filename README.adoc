...
* Si besoin, vous pouvez réduire la taille de ce modèle en utilisant l'outil https://document-template-customizer.florat.net/[Document-Template-Customizer] (utiliser l'URL : `https://github.com/bflorat/modele-da`);
