...
* **Ce modèle peut-t-il servir de base à un référentiel d'architecture ?** Même si ne nombreuses idées peuvent être reprise, non, ce n'est pas l'objet de ce modèle.
