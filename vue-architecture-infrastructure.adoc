...
Éviter également d'utiliser la même valeur dans tous les services d'infrastructure pour éviter les effets inattendus lié à la concomitance des timeouts.
...
|===
|Composant d'infrastructure|Timeout (ms)
