...
l’indisponibilité maximale ici décrite doit suivre le niveau 
...
L’architecture physique, technique voire logicielle peut changer complètement en fonction du besoin de disponibilité (clusters d’intergiciels ou de bases de données, redondances matériels coûteuses, architecture asynchrone, caches de session, failover, etc.). 

Ne pas oublier également les coûts d’astreinte souvent importants si les exigences sont très élevées. De la pédagogie et un devis permettent en général de modérer les exigences.

On estime en général que la haute disponibilité (HA) commence à trois neufs (99%), soit environ 8h45 d'indisponibilité par an.

Détailler la disponibilité demandée par plage.

La disponibilité exigée ici devra être en cohérence avec les Contraintes de disponibilité du SI.
...
//🏷{"id": "f0e94586-876d-46ca-b060-b5dcde468734", "labels": ["niveau::intermédiaire"]}
### Exigences de RPO
...
//🏷{"id": "3e07d851-b2dc-422f-9cba-1b4447a5c956", "labels": ["niveau::intermédiaire", "taille_projet::moyen", "taille_projet::grand", "niveau_detail::général"],"link_to": ["6903a99e-8b8e-464b-909c-d40da5a808d1"]}
### Exigences de RTO
